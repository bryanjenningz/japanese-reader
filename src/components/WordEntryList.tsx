...
export const WordEntryList = ({
  ...
  return selectedTextElementBottom !== undefined && wordEntries.length > 0 ? (
    ...
    >
      <ul
        className="no-scrollbar flex max-h-48 w-full flex-col overflow-y-scroll rounded-lg border border-white bg-black text-white shadow-lg md:max-w-2xl"
...
const WordEntryItem = ({
  ...
  return (
    <li className="flex w-full flex-col border-b border-white p-3 last:border-b-0">
